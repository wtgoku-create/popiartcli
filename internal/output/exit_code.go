...
func ExitCode(err error) int {
	...
	switch code {
	case "BAD_REQUEST", "VALIDATION_ERROR", "INPUT_ERROR", "INPUT_NOT_FOUND", "INPUT_PARSE_ERROR", "LOCAL_SKILL_INVALID", "NOT_FOUND", "NO_PROJECT", "CONFLICT", "LOCAL_SKILL_UNSUPPORTED", "LOCAL_ONLY_SKILL", "UNSUPPORTED_INSTALL":
		return 2
